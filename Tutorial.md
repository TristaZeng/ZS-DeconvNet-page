...
Here is a demo video of screen captures of the training and inference procedures of the ZS-DeconvNet Fiji plugin on two different low SNR dataset (images of lysosomes and endoplasmic reticulum) with two types of operating systems (Windows 10 and Ubuntu 18.04.6 LTS):
